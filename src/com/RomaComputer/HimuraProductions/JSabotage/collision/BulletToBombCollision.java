...
public class BulletToBombCollision extends BasicCollisionGroup
{
    private SabotageGameObject parent;

    private GenerateEnemies ge;

    public BulletToBombCollision(SabotageGameObject sgo)
    {
    ...
    public void collided(Sprite bullet, Sprite bomb)
    {
